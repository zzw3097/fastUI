    ...
    CityPicker.prototype = {
        ...
        render: function() {
            var p = this.getPosition(),
                ...
                textspan = '<span class="city-picker-span '+(this.options.disabled ? 'disabled' : '')+'" style="height:' +
                this.$element.outerHeight() + 'px;">' +
                (placeholder ? '<span class="placeholder">' + placeholder + '</span>' : '') +
                '<span class="title"></span><div class="arrow"></div>' + '</span>',
                dropdown = '<div class="city-picker-dropdown" style="left:15px;top:100%;">' +
        ...
        bind: function() {
            ...
            this.$textspan.on('click', function(e) {
                if($(e.target.parentElement.parentElement).hasClass('disabled')){
                    return;
                }
                var $target = $(e.target),
                    type;
            ...
            this.$dropdown.on('click', '.city-select a', function() {
                ...
                if ($active.data('code') !== $(this).data('code')) {
                    ...
                    $("input[name='"+$this.options.linkField+"']").val($(this).data('code'));
                    var data = $select.data('item');
                    data.count = $select.attr("data-count");
        ...
        open: function(type) {
            type = type || PROVINCE;
            this.$dropdown.css('width',this.$textspan.outerWidth()-2);
            this.$dropdown.show();
